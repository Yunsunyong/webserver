...
<%
	...
	for(String s : hobbies){
		...
		case "cook" : checked[5] = "checked"; break;
		case "travel" : checked[6] = "checked"; break;
		case "movie" : checked[7] = "checked"; break;
...
<form action="/first/mupdate" method="post">
	<table width="650" align="center">
			<tr height="40">
				<th width="150">아아디</th>
				<td><input type="text" name="userid" readonly value="<%=member.getUserId() %>"></td>				
			</tr>
			<tr height="40">
				<th width="150">이  름</th>
			...
			<tr height="40">
				<th width="150">암  호</th>
				<td><input type="password" name="userpwd" id="userpwd1" value="<%=member.getUserPwd() %>"></td>
			...
			<tr height="40">
				...
				<table>
					...
					<tr>
						...
						<td width="150"><input type="checkbox" name="hobby" value="cook" <%= checked[5] %>>요리</td>
					</tr>
					<tr>
						<td width="150"><input type="checkbox" name="hobby" value="travel" <%= checked[6] %>>여행</td>
						<td width="150"><input type="checkbox" name="hobby" value="movie" <%= checked[7] %>>영화</td>
